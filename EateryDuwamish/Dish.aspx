                    ...
                    <asp:Repeater ID="rptDish" runat="server" OnItemDataBound="rptDish_ItemDataBound" OnItemCommand="rptDish_ItemCommand">
                        ...
                        <ItemTemplate>
                            <tr class="odd" role="row" runat="server" onclick="">
                                ...
                                <td>
                                    <asp:LinkButton ID="lbRecipeByDish" runat="server" CommandName="RECIPE">Recipes</asp:LinkButton>
                                    <asp:LinkButton ID="lbEditByDish" runat="server" CommandName="EDIT">Edit</asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
