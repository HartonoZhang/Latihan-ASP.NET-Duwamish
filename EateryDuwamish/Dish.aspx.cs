    ...
    public partial class Dish : System.Web.UI.Page
    {
        ...
        protected void rptDish_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                LinkButton lbRecipeByDish = (LinkButton)e.Item.FindControl("lbRecipeByDish");
                LinkButton lbEditByDish = (LinkButton)e.Item.FindControl("lbEditByDish");
                ...
                lbRecipeByDish.CommandArgument = dish.DishID.ToString();
                lbEditByDish.CommandArgument = dish.DishID.ToString();
