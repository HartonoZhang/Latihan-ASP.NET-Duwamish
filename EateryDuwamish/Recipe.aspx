...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="page-title">RECIPE</div><hr style="margin:0"/>
            <%--FORM RECIPE--%>
            ...
            <div class="row">
                <div class="table-header">
                    <div class="table-header-title">
                        <asp:Literal runat="server" ID="litTableTitle"></asp:Literal>
                    </div>
                    ...
                    <asp:Repeater ID="rptRecipe" runat="server" OnItemDataBound="rptRecipe_ItemDataBound" OnItemCommand="rptRecipe_ItemCommand">
                        ...
                        <ItemTemplate>
                            <tr class="odd" role="row" runat="server" onclick="">
                                ...
                                <td>
                                    <asp:LinkButton ID="lbDetailByRecipe" runat="server" CommandName="DETAIL">Detail</asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
